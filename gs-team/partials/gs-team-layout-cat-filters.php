...
<ul class="<?php echo esc_attr($classes); ?>" style="text-align: <?php echo esc_attr($gs_tm_filter_cat_pos); ?>">
    ...
    <?php if ( $gs_filter_all_enabled == 'on' ) : ?>
        <li class="filter"><a href="javascript:void(0)" data-filter="*" data-phone><?php echo esc_html($fitler_all_text); ?></a></li>
    <?php endif; ?>
    ...
    <?php foreach ( $_terms as $term ) :
        ...
        $found = array_filter($locations, function($loc) use($term) {
            return $loc['location_name'] == $term->name;
        });
...
<div class="office-phone">
    <a href="tel:" id="OfficePhone" style="display: none;"></a>
</div>