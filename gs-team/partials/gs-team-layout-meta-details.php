...
$commercial_personal = get_field( get_the_id(), 'commercial_or_personal');
$commercial_personal = $commercial_personal == 'personal' ? 'Personal Line' : 'Commercial Line';
...
<div class="gstm-details">
    ...
    <?php if ( !empty($land) ) : ?>
        <div class="gs-member-lphon">
            <span class="levels"><?php echo $commercial_personal; ?></span>
